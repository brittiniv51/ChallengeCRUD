...
//   const { ingredients, removeIngredients } = useContext(GlobalContext);
//   return (
//   <Fragment>
...
//             <p className="text-gray-900 leading-none">{ingredient.name}</p>
//             <p className="text-gray-600">{ingredient.type}</p>
//           </div>
